        ...
        // ── Overview ───────────────────────────────────────────────────────────
        {
            ...
            blocks: [
                ...
                },
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "My Role" },
                        { type: "subheading", text: "How I Led This Project" },
                        {
                            type: "paragraphs",
                            items: [
            ...
            blocks: [
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "Approach" },
                        { type: "subheading", text: "Research Methodology" },
                        {
                            type: "paragraphs",
                            items: [
                ...
                },
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "Interviews" },
                        { type: "subheading", text: "Talking to Real Apprentices" },
                        {
                            type: "paragraphs",
                            items: [
                ...
                },
                {
                    ...
                    blocks: [
                        ...
                        { type: "subheading", text: "Survey Findings" },
                        {
                            type: "paragraphs",
                            items: [
                ...
                },
                {
                    ...
                    blocks: [
                        ...
                        { type: "subheading", text: "What Already Exists" },
                        {
                            type: "paragraphs",
                            items: [
                ...
                },
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "User Personas" },
                        { type: "subheading", text: "Who We Designed For" },
                        {
                            type: "paragraphs",
                            items: [
                        ...
                        },
                        {
                            ...
                            linkHref:
                                "https://www.figma.com/board/4TxlwCUXXfpd8TctbKZz0s/User-Personas?node-id=0-1&t=avXFhpYMcNEqx809-1",
                            linkText: "View full persona",
                        },
                    ],
                },
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "Key Findings" },
                        { type: "subheading", text: "What the Research Told Us" },
                        {
                            type: "cardGrid",
                            cards: [
                                {
            ...
            blocks: [
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "Design Philosophy" },
                        { type: "subheading", text: "Restraint as a Design Principle" },
                        {
                            type: "paragraphs",
                            items: [
                ...
                },
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "Features" },
                        {
                            type: "subheading",
                            text: "4 key features to address user pain points (based on survey results)",
                        },
                        {
                            type: "featureCards",
                            cards: [
                ...
                },
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "Visual Design" },
                        { type: "subheading", text: "Visual Design & Style Guide" },
                        {
                            type: "paragraphs",
                            items: ["The visual system was intentionally minimal and calm, using:"],
                        },
                        {
                            type: "bullets",
                            items: [
                ...
                },
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "Site Map" },
                        { type: "subheading", text: "Information Architecture" },
                        {
                            type: "paragraphs",
                            items: [
                ...
                },
                {
                    type: "group",
                    blocks: [
                        { type: "tag", text: "Wireframes" },
                        { type: "subheading", text: "Low-Fidelity Wireframes" },
                        {
                            type: "figmaEmbed",
                            url: "https://embed.figma.com/design/ZehM4zoUzKhYDgKwGjWggV/Got-It---TradeAccess?node-id=3950-10678&embed-host=share",
                        },
                    ],
                },
            ],
            ...
            blocks: [
                {
                    ...
                    blocks: [
                        ...
                        { type: "subheading", text: "High-Fidelity Screens" },
                        {
                            type: "carousel",
