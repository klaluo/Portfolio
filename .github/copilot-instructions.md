...
-   All project detail pages (e.g. GotIt, Daybreak) share the same section structure:
    Overview → Research → Design → Final Product → Reflection.

-   Reusable layout is defined in:
    components/case-study/CaseStudyPage.jsx

-   Project-specific content is stored as data objects under:
    data/caseStudies/<project>.js

-   Route pages under app/projects/<slug>/page.jsx should:

    1. Import the project data object
    2. Import CaseStudyPage
    3. Pass project data + styles to CaseStudyPage

-   Avoid hardcoding large content blocks directly in page.jsx.
    Instead, move content into the corresponding project data file.

    Case Study UI Reuse Rules

-   Do NOT create project-specific section components like ReflectionSection.jsx unless the section contains complex interactive logic.
-   Use CaseStudySection and shared block components instead.
-   Keep layout consistent across case studies unless intentionally redesigned.
