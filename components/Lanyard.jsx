...
export default function Lanyard({
    ...
    if (assetsReady === false) {
        return (
            <div className='lanyard-wrapper lanyard-placeholder'>
                Add `public/lanyard/card.glb` and `public/lanyard/lanyard.png`.
            </div>
        );
    }
    ...
    return (
        <div className='lanyard-wrapper'>
            {assetsReady === true ? (
                ...
                <div className='lanyard-loading'>Loading lanyard…</div>
            )}
        </div>
    );
}
